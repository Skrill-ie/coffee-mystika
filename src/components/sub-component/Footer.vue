    ...
    <div class="bg-black-secondary font-radley">
        <div class="bg-black-primary pt-10 md:pt-0">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-x-20 container mx-auto md:py-10">
                <div class="col-span-4 md:col-span-2 xl:col-span-4 px-3 border-b-2 xl:border-none border-black-secondary">
                ...
                <div class="col-span-4 md:col-span-1 xl:col-span-4 order-3 md:order-2 px-3 lg:px-10 py-10 xl:py-0">
                ...
                <div class="col-span-4 md:col-span-1 xl:col-span-4 order-2 md:order-3 xl:pr-10 lg:px-10 py-10 xl:py-0">
                    <div class="text-3xl mb-10 text-text-title text-left px-3 xl:px-0">We're Here</div>
