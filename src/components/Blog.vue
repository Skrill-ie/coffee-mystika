  ...
  export default {
    ...
    data() {
      return {
        ...
        blogs: [
          { blogImage: (require('@/assets/images/blog/blog-flairnjams-item.png')), blogImageModal: (require('@/assets/images/blog/blog-flairnjams.png')) , title: "Flair 'n Jams at Cafe Mystika", date: 'October 1, 2024', content:"Experience the electrifying fusion of artistry at Cafe Mystika's Flair n' Jams on February 28th! Witness mind-blowing flair bartending skills in the afternoon, followed by an unforgettable evening of live music featuring the best of local artists of Negros Oriental. We have UBVSTE, Entropic, and The Lomboys. "},
